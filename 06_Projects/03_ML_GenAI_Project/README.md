...
[![Gemini](https://img.shields.io/badge/Google%20Gemini-1.5%20Pro-blueviolet?style=flat)](https://ai.google.dev/)
...
### **Step 7: Open UI**
Open `http://localhost:8501` in your browser → Upload a `.pdf`/`.txt`/`.docx` file → Enter research prompt → Validate semantic response.
